...
class TestCodeImplementation:
    @pytest.mark.parametrize("text,reason", [
        ...
        # English prompts commonly generated by Hermes/internal agents
        ("implement fibonacci", "keyword:code_implementation"),
        ("Implement the requested changes", "keyword:code_implementation"),
        ("write a function that parses routes", "keyword:code_implementation"),
        ("create a patch for the classifier", "keyword:code_implementation"),
        ("apply the patch and add tests", "keyword:code_implementation"),
        ("modify the code to support this", "keyword:code_implementation"),
        ("make the requested change", "keyword:code_implementation"),
        # Japanese variants used in follow-up edit prompts
        ("このコードを修正して", "keyword:code_implementation"),
        ("設定ファイルを更新して", "keyword:code_implementation"),
    ])
...
class TestLargeImplementation:
    @pytest.mark.parametrize("text", [
        ...
        "Implement a complete authentication feature across multiple files",
        "Add database schema, API endpoints, migration, and tests for the new feature",
    ])
...
class TestCodeDesign:
    @pytest.mark.parametrize("text,reason", [
        ...
        # English planning/review prompts commonly generated internally
        ("implementation plan for this change", "keyword:code_design"),
        ("architecture review before coding", "keyword:code_design"),
        ("split into PRs", "keyword:code_design"),
        ("impact analysis and rollback plan", "keyword:code_design"),
        ("refactoring plan", "keyword:code_design"),
        ("migration plan", "keyword:code_design"),
    ])
...
class TestCodeDebug:
    @pytest.mark.parametrize("text,reason", [
        ...
        # English/Japanese internal investigation prompts
        ("Find the root cause of the failing test", "keyword:code_debug"),
        ("investigate why pytest failed", "keyword:code_debug"),
        ("why is this failing?", "keyword:code_debug"),
        ("build failed in CI", "keyword:code_debug"),
        ("動かない原因を調べて", "keyword:code_debug"),
        ("テスト失敗の原因を特定して", "keyword:code_debug"),
        ("ビルド失敗を解析して", "keyword:code_debug"),
    ])
...
class TestCodeLight:
    @pytest.mark.parametrize("text,reason", [
        ...
        ("Pythonの使い方を教えて", "keyword:code_light"),
        # Lightweight English/Japanese prompts suitable for Spark
        ("no module named yaml", "keyword:code_light"),
        ("is this command correct?", "keyword:code_light"),
        ("just the command", "keyword:code_light"),
        ("short answer: how do I sort a dict?", "keyword:code_light"),
        ("give me a minimal example", "keyword:code_light"),
        ("one-line fix for this import", "keyword:code_light"),
        ("コマンドだけ教えて", "keyword:code_light"),
        ("Pythonの構文を短く教えて", "keyword:code_light"),
        ("Pythonでdict sortどう書く？", "keyword:code_light"),
    ])
    ...
    def test_generic_brevity_or_usage_without_code_context_is_not_code_light(self, text):
        route, _ = classify_message(text)
        assert route != "code_light"
...
class TestCodeLightContextGuard:
    ...
    def test_large_context_routes_code_light_to_long_context(self):
        ...
        assert route == "long_context"
        assert rsn == "context_tokens>12000:code_light_guard"

    def test_moderate_context_keeps_code_light_under_expanded_guard(self):
        route, rsn = classify_message(
            "pip install の使い方を教えて",
