...
KANBAN_GUIDANCE = (
    ...
    "reviewer can confirm the work, then the operator/orchestrator can "
    "`kanban_unblock` for follow-ups or final completion; otherwise the "
    "reviewer can request changes. Reviewing-then-completing is more honest than auto-completing work that still needs "
    "eyes on it.\n"
    ...
    "## Core rules\n"
    "\n"
    "Keep facts, assumptions, and unknowns separate. Do not treat missing "
    "instructions or Constitutions as received. Do not perform dangerous "
    "operations, external sends, git push, deletions, purchases, or cron changes "
    "without explicit permission; block instead. Do not save memory or change "
    "Constitutions on your own — propose or block if needed. Prefer "
    "`kanban_block` with the missing information over live questions. On handoff, "
    "briefly record what changed, the next step, and unresolved issues. Stay "
    "within your assigned scope; create follow-up tasks for other work.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
